...
| **`contact-context`** | Before warm outreach | Read-only Gmail/M365 + Google Calendar (when connected) → **ContactContextBrief** for **`draft-outreach`** / **`writer`** (Phase **2A**; explicit approval) |
