...
**Job search:** Career Navigator uses the built-in **Indeed connector** (Claude Cowork integration) for live job listings. No token or configuration required — `/career-navigator:search-jobs` works out of the box.
