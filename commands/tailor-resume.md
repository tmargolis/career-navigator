---
name: tailor-resume
command: /career-navigator:tailor-resume
description: >
...
```
/career-navigator:tailor-resume
/career-navigator:tailor-resume [company] [role title]
```
...
> - Track this as an application (/career-navigator:track-application)
> - Generate a cover letter (/career-navigator:cover-letter)
