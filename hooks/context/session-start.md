...
- Otherwise read `CareerNavigator/tracker.json` and surface **critical-only** alerts: imminent offer deadlines, follow-ups due today (or within hours), same-day interview actions that need immediate attention.
